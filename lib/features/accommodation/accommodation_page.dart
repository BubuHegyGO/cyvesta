...
class _AddAccommodationPageState extends State<AddAccommodationPage> {
                    ...
                    Expanded(
                      child: OutlinedButton(
                        style: OutlinedButton.styleFrom(
                          ...
                          padding:EdgeInsets.symmetric(vertical: 14), // ✅ helyes
  ...
  // 4. LÉPÉS (ITT VAN A SAJÁT WEBOLDAL & POP-UP INFÓ)
  Widget _buildStep4() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        // SAJÁT WEBOLDAL MEZŐ + INFÓ POP-UP
        TextFormField(
              ...
              onPressed: () {
                showDialog(
                  ...
                  builder: (context) => AlertDialog(
                    ...
                    title: const Row(
                      children: [
                        Icon(Icons.info_outline, color: Color(0xFF8BC541)),
                        SizedBox(width: 8),
                        Text('Saját weboldal', style: TextStyle(color: Colors.white, fontSize: 18)),
                      ],
                    ),
                    content: const Text(
                      'Ha megadod a saját weboldalad címét (pl. www.szallasod.hu), a vendégek közvetlenül a te oldaladon is böngészhetnek, így növelheted a közvetlen foglalásaid számát!',
                      style: TextStyle(color: Colors.white70, fontSize: 14, height: 1.4),
                    ),
                    actions: [
                      TextButton(
                        onPressed: () => Navigator.pop(context),
                        child: const Text('Rendben', style: TextStyle(color: Color(0xFF8BC541), fontWeight: FontWeight.bold)),
                      ),
                    ],
                  ),
                );
